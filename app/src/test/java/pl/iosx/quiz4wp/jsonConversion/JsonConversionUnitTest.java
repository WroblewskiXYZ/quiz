...
public class JsonConversionUnitTest {
    ...
    public void shouldReturnQuizContent() throws Exception
    {
        ...
        Resources.getResource("quiz_content_6234787811510401.txt");

        Gson gson = new Gson();
        URL url = Resources.getResource("quiz_content_6234787811510401.txt");
        String text = Resources.toString(url, Charset.defaultCharset());

        ApiQuizContent apiQuizContent = gson.fromJson(text,ApiQuizContent.class);
